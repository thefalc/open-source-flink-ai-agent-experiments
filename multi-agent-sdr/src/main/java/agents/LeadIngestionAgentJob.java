...
public class LeadIngestionAgentJob {
  ...
  public static void main(String[] args) throws Exception {
    ...
    // leadResearchStream.map(lead -> {
    //   System.out.println("Scored Lead: " + lead);
    //   return lead;
    // });

    // Write to "incoming_leads_2"
  ...
  public static class LeadResearchFunction implements AsyncFunction<String, String> {
    ...
    public void asyncInvoke(String leadJson, ResultFuture<String> resultFuture) {
      CompletableFuture.supplyAsync(() -> {
        try {
          ...
          String cleanedJson = cleanJsonString(leadJson);
          ...
          ChatCompletionCreateParams.Builder createParamsBuilder = ChatCompletionCreateParams.builder()
              ...
              .addUserMessage(buildPrompt(leadJson, PRODUCT_DESCRIPTION));
          ...
          createParamsBuilder.addUserMessage(buildPrompt(leadJson, PRODUCT_DESCRIPTION));
          ...
          String responseContent = chatCompletion.choices().stream()
            ...
            .collect(Collectors.joining("\n")); // or just use "" if you're sure there's only one choice
    ...
    private static String buildPrompt(String leadDetails, String productDescription) {
      // - Company Website Lookup Tool - Fetches key details from the company's
      // official website.
      // - Salesforce Data Access - Retrieves CRM data about the lead's past
      // interactions, status, and engagement history.
      // - Clearbit Enrichment API - Provides firmographic and contact-level data,
      // including company size, funding, tech stack, and key decision-makers.
      return """
